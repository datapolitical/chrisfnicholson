...
gem 'sass-embedded', github: 'ntkme/sass-embedded-host-ruby', branch: 'main'
gem "jekyll-feed"
gem "jekyll-gist"
...
gem 'jekyll_version_plugin', github: "datapolitical/jekyll-version-plugin", branch: 'master', group: :jekyll_plugins
